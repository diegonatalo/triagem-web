...
import { generateRompimento } from '@/utils/generateMessage'
import { useForm } from 'react-hook-form'
import toast from 'react-hot-toast'

export default function Rompimento() {
  const { register, handleSubmit, reset } = useForm<Rompimento>()

  const onSubmit = handleSubmit((data) => {
    const triagemFormatada = generateRompimento(data)
